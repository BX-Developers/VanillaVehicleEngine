...
execute if score temp_button int matches 1 if score @s ctrl_ws matches 0 run function vehicles:guis/actions/press_wa
execute if score temp_button int matches 1 if score @s ctrl_ws matches 1 run function vehicles:guis/actions/press_sa
...
execute if score temp_button int matches 1 if score @s ctrl_ws matches 0 run function vehicles:guis/actions/press_wd
execute if score temp_button int matches 1 if score @s ctrl_ws matches 1 run function vehicles:guis/actions/press_sd
