...
execute if score @s vehicle_sp > @s vehicle_flyv run scoreboard players operation temp int < -1 int
scoreboard players operation @s vehicle_sp += temp int

scoreboard players operation temp int = @s vehicle_flyu
execute unless entity @s[tag=vehicle_UP] run scoreboard players operation temp int *= -1 int
