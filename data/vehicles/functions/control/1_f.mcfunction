...
execute if score @s vehicle_sp < @s vehicle_flyv store result score @s vehicle_vr1 run data get entity @s Rotation[1] 1000

execute if score @s vehicle_sp >= @s vehicle_flyv at @s run function vehicles:control/1_up