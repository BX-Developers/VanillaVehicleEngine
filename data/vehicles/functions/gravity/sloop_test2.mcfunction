...
scoreboard players operation temp_gtx0 int -= temp_gtx1 int
scoreboard players set surface int 1
execute store result entity @s Pos[1] double 0.0001 run scoreboard players operation temp_gty0 int += temp_gtx0 int